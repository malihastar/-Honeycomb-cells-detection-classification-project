# -*- coding: utf-8 -*-
"""
Created on Mon May 31 15:00:18 2021
...
traing_set=train_datgen.flow_from_directory('C:/Users/MATLAB/Desktop/maliha_data/all_data/train',
                                            target_size=[80,80],
                                            batch_size=batch_size,
                                            class_mode='categorical')
test_set=train_datgen.flow_from_directory('C:/Users/MATLAB/Desktop/maliha_data/all_data/test',
                                            target_size=[80,80],
                                            batch_size=batch_size,
...
def plot_roc_curve(model, val,  model_name):
    ...
    sns.despine()
    plt.show()
    plt.savefig('vgg19c.png')

plot_roc_curve(model,test_set, "VGG19.h5")
